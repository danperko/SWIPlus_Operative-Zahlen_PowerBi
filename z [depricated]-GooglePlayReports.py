...
# Zielverzeichnis in Databricks Volume
target_dir = "/Volumes/swi_audience_prd/swiplus/play_reports/"

# GCS Zugriff initialisieren
fs = gcsfs.GCSFileSystem(token=key_path)

# Liste aller CSV-Dateien im Install-Ordner
files = fs.ls('pubsite_prod_rev_11741298576716878675/stats/installs/')

# Optional: Lokalen Zielordner leeren
for f in os.listdir(target_dir):
    os.remove(os.path.join(target_dir, f))

# Alle Dateien herunterladen und speichern
