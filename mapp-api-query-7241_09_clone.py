...
# payload = replace_time_filter(payload, "2025-01-01 00:00:00", "2025-11-05 00:00:00")
...
if not resultUrl:
    ...
    df.write.format("delta") \
        ...
        .saveAsTable("swi_audience_prd.swiplus.mapp_api_query_7241_09_clone")
...
table_name = "swi_audience_prd.swiplus.mapp_api_query_7241_09_clone"
...
from pyspark.sql.functions import split, col, size, when, to_date
table_name = "swi_audience_prd.swiplus.mapp_api_query_7241_09_clone"
...
# Schritt 5: Tabelle zurückschreiben – in neue Tabelle mit Suffix "_enriched"
