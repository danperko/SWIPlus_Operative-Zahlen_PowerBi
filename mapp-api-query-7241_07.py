...
payload = {
    ...
    "queryObject": {
        "columns": [
            ...
            {
                "name": "event_parameter_text_1",
                "scope": "OBJECT",
                "context": "ACTION"
            },
            {
                "name": "event_parameter_text_2",
                "scope": "OBJECT",
                "context": "ACTION"
            },
            {
                "name": "event_parameter_text_3",
                "scope": "OBJECT",
                "context": "ACTION"
            },
            {
                "name": "event_parameter_text_4",
                "scope": "OBJECT",
                "context": "ATOMIC"
            },
            {
...
if not resultUrl:
    ...
    df.write.format("delta") \
        ...
        .saveAsTable("swi_audience_prd.swiplus.mapp_api_query_7241_07")